...
_Unsmoothed: specially for bigrams, due to the fact that not always are the bigrams present in the corpus, even though they're valid language words. So, as we saw in class, those are not assigned 0, but instead a add a small $ \delta $, and this distributes the probs across, lowering the overall prob._
...
$P(Sam|am) = \frac{2+1}{4+V} = \frac{1+1}{2+V} = \frac{2}{11} 0.1818182$
