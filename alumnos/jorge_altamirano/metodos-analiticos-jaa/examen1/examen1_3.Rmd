...
config$sparklyr.cores.local <- 15
...
ratings_1_spark <- copy_to(sc, ratings_1)
sparklyr::


spark_disconnect(sc, ratings_1)
```
...
_Aunque con Sparklyr no lo pudimos realizar, pyspark funcionó de maravilla: ¡alrededor de 30 segundos!_